...
class FoodPolicy
{
    ...
    {
        return $user->hasPermissionTo('list foods');
    }
    ...
    {
        return $user->hasPermissionTo('view foods');
    }
    ...
    {
        return $user->hasPermissionTo('create foods');
    }
    ...
    {
        return $user->hasPermissionTo('update foods');
    }
    ...
    {
        return $user->hasPermissionTo('delete foods');
    }
