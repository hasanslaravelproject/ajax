                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            @can('view-any', App\Models\MealType::class)
                            <a class="dropdown-item" href="{{ route('meal-types.index') }}">Meal Types</a>
                            @endcan
                            ...
                            @endcan
                            @can('view-any', App\Models\MenuTypes::class)
                            <a class="dropdown-item" href="{{ route('all-menu-types.index') }}">All Menu Types</a>
                            @endcan
                            @can('view-any', App\Models\Order::class)
                            <a class="dropdown-item" href="{{ route('orders.index') }}">Orders</a>
                            @endcan
                            @can('view-any', App\Models\Food::class)
                            ...
                            @endcan
                            @can('view-any', App\Models\FoodType::class)
                            <a class="dropdown-item" href="{{ route('food-types.index') }}">Food Types</a>
                            @endcan
