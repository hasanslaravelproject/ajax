                ...
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right">
                                @lang('crud.stocks.inputs.price')
                            </th>
                            <th class="text-right">
                                @lang('crud.stocks.inputs.quantity')
                            </th>
                            <th class="text-right">
                                @lang('crud.stocks.inputs.total')
                            </th>
                            <th class="text-right">
                                @lang('crud.stocks.inputs.stock')
                            </th>
                            <th class="text-left">
                                @lang('crud.stocks.inputs.company_id')
                            </th>
